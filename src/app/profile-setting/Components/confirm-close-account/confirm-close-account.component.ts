...
@Component({
  selector: 'app-confirm-close-account',
  templateUrl: './confirm-close-account.component.html',
  styleUrls: ['./confirm-close-account.component.scss']
})
export class ConfirmCloseAccountComponent {
  closeResult = '';
  code!: string;
